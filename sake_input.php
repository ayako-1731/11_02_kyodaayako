...
<head>
  ...
  <title>Sakenomi Shopping</title>
</head>

<body>
  <form action="sake_create.php" method="POST">
    ...
    <a href="https://nihonshucalendar.com/" target="_blank">※日本酒イベント情報</a><br>

    <a href="sake_read.php">確認画面</a>
